...
class MotionForReconsideration extends Seeder
{
    /**
    ...
    public function run()
    {
        $document = \App\Models\DocumentType::create([
            ...
            'keywords' => 'Reserve Hearing Date with the Court Calendaring Clerk (only if you\'re filing the motion) at least 23 days before you want the motion to be heard',
