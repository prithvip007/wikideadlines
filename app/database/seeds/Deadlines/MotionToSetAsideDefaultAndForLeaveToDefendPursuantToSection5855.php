...
class MotionToSetAsideDefaultAndForLeaveToDefendPursuantToSection5855 extends Seeder
{
    /**
    ...
    public function run()
    {
        $document = \App\Models\DocumentType::create([
            'name' => 'Motion to Set Aside Default and for Leave to Defend pursuant to Section 585.5',
