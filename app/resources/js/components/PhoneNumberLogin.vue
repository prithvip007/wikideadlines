            ...
            <form @submit.prevent="sendForm" class="p-0 px-md-5 py-md-2">
                <div v-if="currentStep === PHONE_STEP">
                    <div class="form-group d-flex align-items-center flex-column">
                        ...
                        <div v-if="mode === 'update'"  class="text-center mb-3" style="overflow: auto;">Please enter a new phone number1234<br>that you will use to log in to WikiDeadlines</div>
