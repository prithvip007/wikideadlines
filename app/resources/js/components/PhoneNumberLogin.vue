...
<template>
    <div style="overflow:hidden;" class="card card-m">
        ...
        <modal-header-primary v-if="currentStep === PHONE_STEP && mode === 'logging'" :lines="['Phone number change']"></modal-header-primary>
            ...
            <form @submit.prevent="sendForm" class="p-0 px-md-5 py-md-2">
                <div v-if="currentStep === PHONE_STEP">
                    <div class="form-group d-flex align-items-center flex-column">
                        ...
                        <div v-if="mode === 'logging'"  class="text-center mb-3">Please enter a new phone number<br>that you will use to log in to WikiDeadlines</div>
