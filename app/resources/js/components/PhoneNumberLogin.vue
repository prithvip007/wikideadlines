                ...
                <div v-if="currentStep === PHONE_STEP">
                    <div class="form-group d-flex align-items-center flex-column">
                        ...
                        <div v-if="mode === 'signup'" class="text-center mb-3">Please enter your phone number<br>to sign up to WikiDeadlines</div>
                            <vue-phone-number-input border-radius="10"  class="w-100 d-block" size="sm" :no-example="true" autofocus v-on:update="handlePhoneNumberUpdate" autocomplete="tel" required v-model="phone"></vue-phone-number-input>
